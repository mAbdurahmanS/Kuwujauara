...
<html lang="en">
  <head>
    ...
    <title>Dashboard | KUWUW JUARA</title>
                ...
                <div class="col-md-4 col-sm-4 ">
                  <div class="x_panel tile fixed_height_320 overflow_hidden">
                    <div class="x_title">
                      <h2>RW 05 | RT 02</h2>
                      <ul class="nav navbar-right panel_toolbox ">
                      <li><a class="text-warning"  href="form_validation.php?hal=edit&rt=<?=$b14['input_rt']?>&rw=<?=$b14['input_rw']?>">Edit</a></li>
                        <li><a class="text-success"  href="view_data.php?hal=lihat&rt=<?=$b14['input_rt']?>&rw=<?=$b14['input_rw']?>">Lihat</a></li>
      ...
      <!-- QC Kalideres -->
        <script type="text/javascript">
          ...
          var qc = new Chart(ctx, {
            type: 'pie',
            data: {
              labels: ["<?=$datam['kuwu1']?>", "<?=$datam['kuwu2']?>", "<?=$datam['kuwu3']?>", "<?=$datam['kuwu4']?>", "<?=$datam['kuwu5']?>", "Ragu - ragu", ],
              datasets: [{
                label: '',
                  data: [<?=$kskuwu1?>, <?=$kskuwu2?>, '0', '0', '0', <?=$kskuwu7?>],
                  backgroundColor: ['#007bff', '#dc3545', '#219653', '#F2C94C', '#9B51E0', '#ddd'],
              },
            ],
            },
          });
          ...
          var alldata = new Chart(ctx, {
            ...
            data: {
              ...
              datasets: [{
                ...
                label: 'Ragu - ragu',
                  data: [<?=$stpsr1;?>,<?=$stpsr2;?>,<?=$stpsr3;?>,<?=$stpsr4;?>,<?=$stpsr5;?>,<?=$stpsr6;?>,<?=$stpsr7;?>,<?=$stpsr8;?>,<?=$stpsr9;?>,<?=$stpsr10;?>,<?=$stpsr11;?>,<?=$stpsr12;?>,<?=$stpsr13;?>,<?=$stpsr14;?>,<?=$stpsr15;?>],
                  backgroundColor: '#ddd',
              },
            ],
            },
      ...
      <script type="text/javascript">
        ...
        var rt1 = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              label: '',
                data: [<?=$kadinart1;?>,<?=$suhernirt1;?>,<?=$ragu1;?>],
      ...
      <script type="text/javascript">
        ...
        var rt2 = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              label: '',
                data: [<?=$kadinart2;?>,<?=$suhernirt2;?>,<?=$ragu2;?>],
                backgroundColor: ['#007bff', '#dc3545'],
            }],
          },
        });
      ...
      <script type="text/javascript">
        ...
        var rt3 = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              label: '',
                data: [<?=$kadinart3;?>,<?=$suhernirt3;?>,<?=$ragu3;?>],
                backgroundColor: ['#007bff', '#dc3545'],
            }],
          },
        });
      ...
      <script type="text/javascript">
        ...
        var dusun3 = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              label: '',
                data: [<?=$kadinart4;?>,<?=$suhernirt4;?>,<?=$ragu4;?>],
                backgroundColor: ['#007bff', '#dc3545'],
            }],
          },
        });
      ...
      <script type="text/javascript">
        ...
        var rt5 = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              label: '',
                data: [<?=$kadinart5;?>,<?=$suhernirt5;?>,<?=$ragu5;?>],
                backgroundColor: ['#007bff', '#dc3545'],
            }],
          },
        });
      ...
      <script type="text/javascript">
        ...
        var rt6 = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              label: '',
                data: [<?=$kadinart6;?>,<?=$suhernirt6;?>,<?=$ragu6;?>],
                backgroundColor: ['#007bff', '#dc3545'],
            }],
          },
        });
      ...
      <script type="text/javascript">
        ...
        var rt7 = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              label: '',
                data: [<?=$kadinart7;?>,<?=$suhernirt7;?>,<?=$ragu7;?>],
                backgroundColor: ['#007bff', '#dc3545'],
            }],
          },
        });
      ...
      <script type="text/javascript">
        ...
        var rt8 = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              label: '',
                data: [<?=$kadinart8;?>,<?=$suhernirt8;?>,<?=$ragu8;?>],
                backgroundColor: ['#007bff', '#dc3545'],
            }],
          },
        });
      ...
      <script type="text/javascript">
        ...
        var rt9 = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              label: '',
                data: [<?=$kadinart9;?>,<?=$suhernirt9;?>,<?=$ragu9;?>],
                backgroundColor: ['#007bff', '#dc3545'],
            }],
          },
        });
      ...
      <script type="text/javascript">
        ...
        var rt10 = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              label: '',
                data: [<?=$kadinart10;?>,<?=$suhernirt10;?>,<?=$ragu10;?>],
                backgroundColor: ['#007bff', '#dc3545'],
            }],
          },
        });
      ...
      <script type="text/javascript">
        ...
        var rt11 = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              label: '',
                data: [<?=$kadinart11;?>,<?=$suhernirt11;?>,<?=$ragu11;?>],
                backgroundColor: ['#007bff', '#dc3545'],
            }],
          },
        });
      ...
      <script type="text/javascript">
        ...
        var rt12 = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              label: '',
                data: [<?=$kadinart12;?>,<?=$suhernirt12;?>,<?=$ragu12;?>],
                backgroundColor: ['#007bff', '#dc3545'],
            }],
          },
        });
      ...
      <script type="text/javascript">
        ...
        var rt13 = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              label: '',
                data: [<?=$kadinart13;?>,<?=$suhernirt13;?>,<?=$ragu13;?>],
                backgroundColor: ['#007bff', '#dc3545'],
            }],
          },
        });
      ...
      <script type="text/javascript">
        ...
        var rt14 = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              label: '',
                data: [<?=$kadinart14;?>,<?=$suhernirt14;?>,<?=$ragu14;?>],
                backgroundColor: ['#007bff', '#dc3545'],
            }],
          },
        });
      ...
      <script type="text/javascript">
        ...
        var rt15 = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              label: '',
                data: [<?=$kadinart15;?>,<?=$suhernirt15;?>,<?=$ragu15;?>],
                backgroundColor: ['#007bff', '#dc3545'],
            }],
          },
        });
      ...
      <script type="text/javascript">
        ...
        var rt16 = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              label: '',
                data: [<?=$kadinart16;?>,<?=$suhernirt16;?>,<?=$ragu16;?>],
                backgroundColor: ['#007bff', '#dc3545'],
            }],
          },
        });
      ...
      <script type="text/javascript">
        ...
        var rt17 = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              label: '',
                data: [<?=$kadinart17;?>,<?=$suhernirt17;?>,<?=$ragu17;?>],
                backgroundColor: ['#007bff', '#dc3545'],
            }],
          },
        });
      ...
      <script type="text/javascript">
        ...
        var rt18 = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              label: '',
                data: [<?=$kadinart18;?>,<?=$suhernirt18;?>,<?=$ragu18;?>],
                backgroundColor: ['#007bff', '#dc3545'],
            }],
          },
        });
      ...
      <script type="text/javascript">
        ...
        var rt19 = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              label: '',
                data: [<?=$kadinart19;?>,<?=$suhernirt19;?>,<?=$ragu19;?>],
                backgroundColor: ['#007bff', '#dc3545'],
            }],
          },
        });
      ...
      <script type="text/javascript">
        ...
        var rt20 = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              label: '',
                data: [<?=$kadinart20;?>,<?=$suhernirt20;?>,<?=$ragu20;?>],
                backgroundColor: ['#007bff', '#dc3545'],
            }],
          },
        });
      ...
      <script type="text/javascript">
        ...
        var rt21 = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              label: '',
                data: [<?=$kadinart21;?>,<?=$suhernirt21;?>,<?=$ragu21;?>],
                backgroundColor: ['#007bff', '#dc3545'],
            }],
          },
        });
      ...
      <script type="text/javascript">
        ...
        var rt22 = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              label: '',
                data: [<?=$kadinart22;?>,<?=$suhernirt22;?>,<?=$ragu22;?>],
                backgroundColor: ['#007bff', '#dc3545'],
            }],
          },
        });
      ...
      <script type="text/javascript">
        ...
        var rt23 = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              label: '',
                data: [<?=$kadinart23;?>,<?=$suhernirt23;?>,<?=$ragu23;?>],
                backgroundColor: ['#007bff', '#dc3545'],
            }],
          },
        });
      ...
      <script type="text/javascript">
        ...
        var rt24 = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              label: '',
                data: [<?=$kadinart24;?>,<?=$suhernirt24;?>,<?=$ragu24;?>],
                backgroundColor: ['#007bff', '#dc3545'],
            }],
          },
        });
      ...
      <script type="text/javascript">
        ...
        var rt25 = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              label: '',
                data: [<?=$kadinart25;?>,<?=$suhernirt25;?>,<?=$ragu25;?>],
                backgroundColor: ['#007bff', '#dc3545'],
            }],
          },
        });
      ...
      <script type="text/javascript">
        ...
        var rt26 = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              label: '',
                data: [<?=$kadinart26;?>,<?=$suhernirt26;?>,<?=$ragu26;?>],
                backgroundColor: ['#007bff', '#dc3545'],
            }],
          },
        });
      ...
      <script type="text/javascript">
        ...
        var rt27 = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              label: '',
                data: [<?=$kadinart27;?>,<?=$suhernirt27;?>,<?=$ragu27;?>],
                backgroundColor: ['#007bff', '#dc3545'],
            }],
          },
        });
