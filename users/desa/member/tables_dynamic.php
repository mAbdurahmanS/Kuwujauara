...
<html lang="en">
  <head>
    ...
    <title>Data | Data Seluruh Penduduk</title>
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Input Data <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="form_validation.php">Input Data PILWU</a></li>
                    </ul>
                  </li>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="tabell" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        <?php
                        $tampil = mysqli_query($db, "SELECT * FROM dbpendudukkalideres order by id");
