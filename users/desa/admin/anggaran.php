<?php
  ...
  {
      //Data simpan sukses
        $simpan = mysqli_query($db, "INSERT INTO tb_anggaran set
        daerah = '$_POST[tdaerah]',
        nama = '$_POST[tnama]',
        kebutuhan = '$_POST[tkebutuhan]',
        link = '$_POST[tlink]',
        anggaran_masuk = '$_POST[tmasuk]',
        anggaran_keluar = '$_POST[tkeluar]'
        ");
  ...
  if(isset($_POST['updatedata']))
  {
    ...
    $unama = $_POST['unama'];
    $ukebutuhan = $_POST['ukebutuhan'];
    $ulink = $_POST['ulink'];
    $umasuk = $_POST['umasuk'];
    $ukeluar = $_POST['ukeluar'];

    //Data akan diedit
    $edit = mysqli_query($db, "UPDATE tb_anggaran set
    daerah = '$_POST[udaerah]',
    nama = '$_POST[unama]',
    kebutuhan = '$_POST[ukebutuhan]',
    link = '$_POST[ulink]',
    anggaran_masuk = '$_POST[umasuk]',
    anggaran_keluar = '$_POST[ukeluar]'
    WHERE id = '$id'
    ");
    ...
    if($_GET['hal'] == "hapus")
  {
    ...
    $hapus = mysqli_query($db, "DELETE FROM tb_anggaran WHERE id = '$_GET[id]' ");
    // if($hapus){
    //   echo "<script>
...
<head>
    ...
    <title>Anggaran | KUWU JUARA</title>
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <form action="" method="post">
                              <div class="form-group">
                                <label>Daerah</label>
                                  <select name="tdaerah" id="tdaerah" class="form-control" required>
                                      ...
                                      <option value="gegesik_kidul">Gegesik Kidul</option>
                              ...
                              <div class="form-group">
                                  <label>RAB</label>
                                 <input type="text" id="tkebutuhan" name="tkebutuhan" class="form-control" required>
                              </div>

                              <div class="form-group">
                                  <label>Link</label>
                                  <input type="text" id="tlink" name="tlink" class="form-control">
                              </div>

                              <div class="form-group">
                                  <label>Anggaran Masuk</label>
                                  <input type="text" id="tmasuk" name="tmasuk" class="form-control" required>
                              </div>
                              
                              <div class="form-group">
                                  <label>Anggaran Keluar</label>
                                  <input type="text" id="tkeluar" name="tkeluar" class="form-control">
                              </div>
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <form action="" method="post">
                              ...
                              <div class="form-group">
                                  <label>RAB</label>
                                 <input type="text" id="ukebutuhan" name="ukebutuhan" class="form-control" required>
                              </div>

                              <div class="form-group">
                                  <label>Link</label>
                                  <input type="text" id="ulink" name="ulink" class="form-control">
                              </div>

                              <div class="form-group">
                                  <label>Anggaran Masuk</label>
                                  <input type="text" id="umasuk" name="umasuk" class="form-control" required>
                              </div>
                              
                              <div class="form-group">
                                  <label>Anggaran Keluar</label>
                                  <input type="text" id="ukeluar" name="ukeluar" class="form-control" required>
                              </div>
                  ...
                  <div class="x_panel">
                    ...
                    <div class="x_content">
                      ...
                      <table id="tabell" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                        ...
                        $search = $_POST['search'];
                        if($search != ''){
                          $tampil = mysqli_query($db, "SELECT * FROM tb_anggaran WHERE daerah LIKE '%".$search."%' OR nama LIKE '%".$search."%' OR kebutuhan LIKE '%".$search."' ");
                        }else{
                          $tampil = mysqli_query($db, "SELECT * FROM tb_anggaran ");
                        }
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><?=$data['anggaran_masuk']?></td>
                            <td><?=$data['anggaran_keluar']?></td>
                            <td class="text-center">
                              <a data-toggle="modal" id="tombolubah" data-target="#editmodal" class="btn btn-warning btn_edit"
                              data-id ="<?= $data['id']?>"
                              data-daerah ="<?= $data['daerah']?>"
                              data-nama ="<?= $data['nama']?>"
                              data-kebutuhan ="<?= $data['kebutuhan']?>"
                              data-link ="<?= $data['link']?>"
                              data-masuk ="<?= $data['masuk']?>"
                              data-keluar ="<?= $data['keluar']?>"
                              ><i class='bx bx-edit' ></i></a>
                              <a href="anggaran.php?hal=hapus&id=<?=$data['id']?>" onclick="return confirm('Apakah yakin ingin menghapus data ini?')" class="btn btn-danger"><i class='bx bx-trash' ></i></a>
                            </td>
                          </tr>
                        </tbody>
                        <?php endwhile;}else{
