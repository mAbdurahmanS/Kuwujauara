<?php
  ...
  //ambil data total
  $get1 = mysqli_query($db, "SELECT * FROM t_input_kalideres WHERE input_rt = '$_GET[rt]' and input_rw = '$_GET[rw]'and input_pilihan = 'Kadina'");
  $kadina = mysqli_num_rows($get1);

  $get2 = mysqli_query($db, "SELECT * FROM t_input_kalideres WHERE input_rt = '$_GET[rt]' and input_rw = '$_GET[rw]' and input_pilihan = 'Hj. Suherni'");
...
<html lang="en">
  <head>
    ...
    <title>Edit Data | KUWU JUARA</title>
